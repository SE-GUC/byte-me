...
const functions = {
    getcoworking: async () =>{  
        const coworkinggetter = await axios.get('http://localhost:8000/api/coworking')
        return coworkinggetter.data
    }, 
    updatecoworking: async (id,desc) =>{
        const coworkingupdate = await axios.put('http://localhost:8000/api/coworking/update/'+id,{coworkingDescription:desc})
        console.log(coworkingupdate)
        return coworkingupdate
    },
    deletecoworking: async (id) =>{
        const coworkingdelete = await axios.delete('http://localhost:8000/api/coworking/delete/'+id,{})
        return coworkingdelete
    }   ,
    postcoworking : async () =>{
        return axios({
            method:'post',
            url:'localhost:8000/api/coworking/create',
    ...
    getcoworkingdesc: async(id)=>{
        const gete =await axios.get('http://localhost:8000/api/coworking/'+id,{})
